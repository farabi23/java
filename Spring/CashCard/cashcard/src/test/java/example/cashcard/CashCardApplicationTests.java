...
class CashCardApplicationTests {
    ...
    @Test
    void
    shouldNotAllowAccessToCashCardsTheyDoNotOwn() {
        ResponseEntity<String> response = restTemplate.withBasicAuth("sarah1", "abc123")
    ...
    void shouldUpdateAnExistingCashCard() {
        ...
        withBasicAuth("sarah1", "abc123").exchange("/cashcards/99", HttpMethod.PUT,request,Void.class);
    ...
    @Test
    void
    shouldNotUpdateACashCardThatIsOwnedBySomeoneElse(){
    ...
    void shouldNotAllowDeletionOfCashCardsTheyDoNotOwn(){
        ...
        restTemplate.withBasicAuth("kumar2", "xyz789")
        .getForEntity("/cashcards/102", String.class);
